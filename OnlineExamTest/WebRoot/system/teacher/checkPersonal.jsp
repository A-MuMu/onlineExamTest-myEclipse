						...
						<table style="border-collapse: collapse; table-layout: fixed"
							...
							<tbody>
								...
								<tr
									...
									<td colspan=3><span id=contentplaceholder1_lb_lxdh>
											<input type="text"
											style="color:blue; height:30px; width:348px; border:0px ; font-size: 95% ;"
											value="<%=teacher.getTel()%>(点击修改)" id="tel" name="tel"
											onfocus="if (value =='(点击修改)'){value =''; this.style.color='red'}"
											onblur="if (value ==''){value='(点击修改)'}" />
									</span></td>
									<td align=center>e-mail*</td>
									<td colspan=2><span id=contentplaceholder1_lb_email>
											<input type="text"
											style="color:blue; height:30px; width:217px; border:0px ; font-size: 95% ;"
											value="<%=teacher.getEmailTea()%>(点击修改)" id="e-mail"
											name="e-mail"
											onfocus="if (value =='(点击修改)'){value =''; this.style.color='red'}"
											onblur="if (value ==''){value='(点击修改)'}" />
									</span></td>
								...
								<tr
									...
									<td><span id=contentplaceholder1_lb_ssdz> <input
											type="text"
											style="color:blue; height:30px; width:109px; border:0px ; font-size: 95% ;"
											value="<%=teacher.getSushe()%>(点击修改)" id="sushe" name="sushe"
											onfocus="if (value =='(点击修改)'){value =''; this.style.color='red'}"
											onblur="if (value ==''){value='(点击修改)'}" />
									</span></td>
									<td align=center>宿舍电话*</td>
									<td><span id=contentplaceholder1_lb_ssdh> <input
											type="text"
											style="color:blue; height:30px; width:109px; border:0px ; font-size: 95% ;"
											value="<%=teacher.getSusheTel()%>(点击修改)" id="sushe-tel"
											name="sushe-tel"
											onfocus="if (value =='(点击修改)'){value =''; this.style.color='red'}"
											onblur="if (value ==''){value='(点击修改)'}" />
									</span></td>
									<td align=center>家庭电话*</td>
									<td colspan=2><span id=contentplaceholder1_lb_jtdh>
											<input type="text"
											style="color:blue; height:30px; width:217px; border:0px ; font-size: 95% ;"
											value="<%=teacher.getHomeTel()%>(点击修改)" id="home-tel"
											name="home-tel"
											onfocus="if (value =='(点击修改)'){value =''; this.style.color='red'}"
											onblur="if (value ==''){value='(点击修改)'}" />
									</span></td>
								...
								<tr
									...
									<td colspan=3><span id=contentplaceholder1_lb_jtdz><%=teacher.getHome()%>
											<input type="text"
											style="color:blue; height:30px; width:348px; border:0px ; font-size: 95% ;"
											value="<%=teacher.getHome()%>(点击修改)" id="home" name="home"
											onfocus="if (value =='(点击修改)'){value =''; this.style.color='red'}"
											onblur="if (value ==''){value='(点击修改)'}" /> </span></td>
									<td align=center>家庭邮编*</td>
									<td colspan=2><span id=contentplaceholder1_lb_yzbm>
											<input type="text"
											style="color:blue; height:30px; width:217px; border:0px ; font-size: 95% ;"
											value="<%=teacher.getYoubian()%>(点击修改)" id="youbian"
											name="youbian"
											onfocus="if (value =='(点击修改)'){value =''; this.style.color='red'}"
											onblur="if (value ==''){value='(点击修改)'}" />
									</span></td>
