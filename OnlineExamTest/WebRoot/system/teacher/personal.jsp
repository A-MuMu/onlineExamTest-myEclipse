...
<script type="text/javascript">
	function redirect() {
		window.location.href("checkPersonal.jsp");
	}
	...
	function preview() {
		...
		prnhtml = bdhtml.substring(bdhtml.indexOf(sprnstr) + 0); //从开始代码向后取html 
		...
		<div class="box2">
			<div class="page_content2">
				...
				<div class="page_nav2">
					...
					<center>
						<input onclick="redirect()" id="bt_edit" type="submit" value="修改"
							name="bt_edit" style="height: 25px ; width: 45px" /> 
						&nbsp;&nbsp;
						<input
							onclick="preview()" id="bt_print" type="submit" value="打印"
