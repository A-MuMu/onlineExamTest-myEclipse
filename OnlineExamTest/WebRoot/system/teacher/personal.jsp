		...
		<div class="box2">
			<div class="page_content2">
				<div class="page_nav2">
					<br />
					<center>
						<font color=#666600 size=6><b>福州大学教师个人信息一览表</b></font>
					</center>
					<center>
						<input id="bt_edit" type="submit" value="修改" name="bt_edit" style="height: 25px ; width: 45px"/> 
						<input
							onclick="preview_main()" id="bt_print" type="submit" value="打印"
							name="bt_print" style="height: 25px ; width: 45px"/>
					</center>
					<br />
					<%
					...
					<table style="border-collapse: collapse; table-layout: fixed"
						...
						<tbody>
							...
							<tr
								...
								<td><span id=contentplaceholder1_lb_bxxs><%=teacher.getXueyuan() %></span></td>
								<td align=center>所在专业</td>
								<td><span id=contentplaceholder1_lb_bxlx><%=teacher.getZhuanye() %></span></td>
								<td align=center>入职方式</td>
								<td><span id=contentplaceholder1_lb_rxfs><%=teacher.getRuzhiFs() %></span></td>
							</tr>

							<tr
								style="height: 30px; vertical-align: middle; border-bottom: gray 1px solid; border-left: gray 1px solid">
								<td align=center>职位</td>
								<td><span id=contentplaceholder1_lb_rxny><%=teacher.getZhiwei() %></span></td>
								<td align=center>入职年月</td>
								<td><span id=contentplaceholder1_lb_xz><%=teacher.getRuzhiDate() %></span></td>
