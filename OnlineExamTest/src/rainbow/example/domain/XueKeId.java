...
public class XueKeId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof XueKeId))
			return false;
		XueKeId castOther = (XueKeId) other;

		return ((this.getXkid() == castOther.getXkid()) || (this.getXkid() != null
				&& castOther.getXkid() != null && this.getXkid().equals(
				castOther.getXkid())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getXkid() == null ? 0 : this.getXkid().hashCode());
		result = 37 * result
